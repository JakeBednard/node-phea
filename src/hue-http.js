...
module.exports = {
    ...
    'getGroup': getGroup,
    'setEntertainmentMode': setEntertainmentMode
}
...
async function setEntertainmentMode(state=true, ip, username, group) {

    try {
        
        let setStateQuery = {
            method: 'PUT',
            uri: util.format('http://%s/api/%s/groups/%s', ip, username, group),
            json: true,
